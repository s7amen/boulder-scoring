...
function bsp_leaderboard_shortcode($atts) {
    ...
    echo '<thead><tr>
        <th class="px-3 py-2 border text-center">Място</th>
        <th class="px-3 py-2 border">Състезател</th>
        <th class="px-3 py-2 border text-center">Точки</th>
    ...
    foreach ($users as $u) {
        echo '<tr>
            <td class="px-3 py-2 border text-center">' . $place . '</td>
            <td class="px-3 py-2 border">' . esc_html($u['username']) . '</td>
            <td class="px-3 py-2 border text-center">' . esc_html(round($u['score'], 1)) . '</td>
            <td class="px-3 py-2 border text-center">' . esc_html($u['tops']) . '</td>
            <td class="px-3 py-2 border text-center">' . esc_html($u['zones']) . '</td>
            <td class="px-3 py-2 border text-center">' . esc_html($u['top_attempts']) . '</td>
            <td class="px-3 py-2 border text-center">' . esc_html($u['zone_attempts']) . '</td>
        </tr>';
        $place++;
    }
